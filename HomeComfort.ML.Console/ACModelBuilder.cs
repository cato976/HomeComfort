...
{
    public static class ACModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\temp\ComfortrData.csv";
        private static string MODEL_FILE = ACConsumeModel.MLNetModelPath;
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Concatenate("Features", new[] { "OutdoorTemp", "IndoorTemp" });
            // Set the training algorithm 
            var trainer = mlContext.Regression.Trainers.FastTree(labelColumnName: @"TurnOnAC", featureColumnName: "Features");
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.Regression.CrossValidate(trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "TurnOnAC");
